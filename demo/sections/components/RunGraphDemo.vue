...
<script lang="ts" setup>
  ...
  import graph2kJson from '@/demo/data/graph-2k.json'
  import graphSmallLongJson from '@/demo/data/graph-small-long.json'
  import graphSmallJson from '@/demo/data/graph-small.json'
  import eventsJson from '@/demo/data/graph-small_events.json'
  import graphSubflowsJson from '@/demo/data/graph-subflows.json'
  import graphXsmallProgressArtifactsJson from '@/demo/data/graph-xsmall-progress-artifacts.json'
  import graphXsmallJson from '@/demo/data/graph-xsmall.json'
