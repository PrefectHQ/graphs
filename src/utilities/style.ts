...
export function parseThemeOptions(overrides?: ThemeStyleOverrides): ParsedThemeStyles {
  return {
    ...
    colorButtonBorder: overrides?.colorButtonBorder ? colorToHex(overrides.colorButtonBorder) : null,
    ...
    spacingButtonBorderWidth: spacingToNumber(overrides?.spacingButtonBorderWidth ?? '1px'),
